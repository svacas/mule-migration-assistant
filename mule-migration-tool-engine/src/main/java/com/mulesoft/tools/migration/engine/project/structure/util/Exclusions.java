...
public enum Exclusions {
  ...
  CLASSPATH(".classpath"), GIT(".gitignore"), PROJECT(".project"), MULE(".mule"), SETTINGS(".settings"), TARGET(
      "target"), MULE_THREE_APP(MuleThreeApplication.srcMainConfigurationPath), MULE_THREE_TEST(
