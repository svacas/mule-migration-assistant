    ...
    Function<Element, Element> f = e -> {
      if (e != null) {
        ...
        if (attribute != null && child != null) {
          ...
          // TODO missing reporting com.mulesoft.tools.migration.library.step.MoveAttributeToChildNode.execute()
        }
      }
      return e;
    };
  ...
  public static Function<Element, Element> addChildNode(String nameSpace, String name) {
    Function<Element, Element> f = e -> {
      ...
      if (e.getChild(name, ns) == null) {
        ...
        // TODO missing reporting com.mulesoft.tools.migration.library.step.CreateChildNode.execute
      } else {
        // TODO missing reporting com.mulesoft.tools.migration.library.step.CreateChildNode.execute
      }
      return e;
