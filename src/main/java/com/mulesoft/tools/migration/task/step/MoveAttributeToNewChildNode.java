            ...
            for (Element node : getNodes()) {
                ...
                if (att != null) {
                    ...
                    if (child != null) {
                        ...
                        getReportingStrategy().log("Moved attribute " + att.getName() + "=\""+ att.getValue() + "\" to new child node <" + newChild.getQualifiedName() + ">", RULE_APPLIED, this.getDocument().getBaseURI(), null , this);
                    }
                }
            }
        } catch (Exception ex) {
