...
public class ProxyDomainMigrationTestCase extends EndToEndTestCase {
  ...
  public static Object[][] params() {
    return new Object[][] {
        new Object[] {"api-gateway", "proxy-domain"}
    };
  }
  ...
  public ProxyDomainMigrationTestCase(String domainToMigrate, String appToMigrate) {
  ...
  public void test() throws Exception {
    ...
    startStopMule(migratedAppDescriptor, migratedAppArtifact, "-M-DhttpPort=" + httpPort.getValue(), "-M-Dapi.id=42");
  }
