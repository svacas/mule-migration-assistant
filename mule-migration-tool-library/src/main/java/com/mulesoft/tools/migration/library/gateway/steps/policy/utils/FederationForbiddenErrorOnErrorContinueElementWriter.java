...
/**
 * Migrate federation forbidden error handler element
 *
 * @author Mulesoft Inc.
 */
public class FederationForbiddenErrorOnErrorContinueElementWriter extends OnErrorContinueElementWriter {

  private static final String FEDERATION_FORBIDDEN_ERROR_TYPE = "FEDERATION:FORBIDDEN_ERROR";

  @Override
  protected String getOnErrorContinueType() {
    return FEDERATION_FORBIDDEN_ERROR_TYPE;
  }
