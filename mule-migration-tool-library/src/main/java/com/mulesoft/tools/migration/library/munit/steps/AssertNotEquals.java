...
import static com.mulesoft.tools.migration.project.model.ApplicationModelUtils.updateMUnitAssertionNotEqualsExpression;
 ...
 * @author Mulesoft Inc.
 */
public class AssertNotEquals extends AbstractApplicationModelMigrationStep {

  public static final String XPATH_SELECTOR = "//*[local-name()='assert-not-same']";
