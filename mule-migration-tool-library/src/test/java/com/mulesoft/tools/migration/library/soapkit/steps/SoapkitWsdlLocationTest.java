...
public class SoapkitWsdlLocationTest {
  ...
  private static String BASE_PATH = "mule/apps/soapkit/steps/wsdlLocation/";
  ...
  public static Object[] params() throws URISyntaxException {
    final URL resource = SoapkitWsdlLocationTest.class.getResource("/" + BASE_PATH);
  ...
  public SoapkitWsdlLocationTest(String filePrefix) {
  ...
  public void setUp() throws IOException {
    ...
    final File originalFolder = new File(SoapkitWsdlLocationTest.class.getResource('/' + BASE_PATH + filePrefix).getFile());
  ...
  public void execute() throws Exception {
    new SoapkitWsdlLocation().execute(projectPath, mock(MigrationReport.class));
