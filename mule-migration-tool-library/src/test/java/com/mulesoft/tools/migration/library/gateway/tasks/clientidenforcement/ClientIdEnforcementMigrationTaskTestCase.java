...
public class ClientIdEnforcementMigrationTaskTestCase {

  private static final Path CLIENT_ID_ENFORCEMENT_EXAMPLES_PATH =
      Paths.get("mule/apps/gateway/client-id-enforcement");
  ...
  public static Collection<Object[]> params() {
    return asList(new Object[][] {
        {"client-id-enforcement-mule3.xml", "client-id-enforcement-mule4.xml"},
        {"client-id-enforcement-no-basic-auth-mule3.xml", "client-id-enforcement-no-basic-auth-mule4.xml"},
        {"client-id-enforcement-no-basic-auth-client-id-mule3.xml", "client-id-enforcement-no-basic-auth-client-id-mule4.xml"},
        {"client-id-enforcement-no-basic-auth-client-secret-mule3.xml",
            "client-id-enforcement-no-basic-auth-client-secret-mule4.xml"},
        {"client-id-enforcement-validate-client-id-mule3.xml", "client-id-enforcement-validate-client-id-mule4.xml"},
    });
  }

  public ClientIdEnforcementMigrationTaskTestCase(final String original, final String target) {
    configPath = CLIENT_ID_ENFORCEMENT_EXAMPLES_PATH.resolve("original/" + original);
    targetPath = CLIENT_ID_ENFORCEMENT_EXAMPLES_PATH.resolve("expected/" + target);
  ...
  public void setUp() throws Exception {
    ...
    ClientIdEnforcementMigrationTask task = new ClientIdEnforcementMigrationTask();
