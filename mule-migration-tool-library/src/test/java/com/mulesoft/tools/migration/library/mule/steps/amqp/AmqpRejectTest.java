...
public class AmqpRejectTest {
  ...
  public AmqpRejectTest(String amqpPrefix) {
  ...
  public void setUp() throws Exception {
    ...
    amqpReject = new AmqpReject();
    amqpReject.setApplicationModel(appModel);
  ...
  public void execute() throws Exception {
    ...
    getElementsFromDocument(doc, amqpReject.getAppliedTo().getExpression())
        .forEach(node -> amqpReject.execute(node, report.getReport()));
