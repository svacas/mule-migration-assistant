...
public class AsyncTest {
  ...
  public AsyncTest(String filePrefix) {
  ...
  public void setUp() throws Exception {
    ...
    async = new Async();
    async.setApplicationModel(appModel);
  }

  @Test
  public void execute() throws Exception {
    getElementsFromDocument(doc, async.getAppliedTo().getExpression())
        .forEach(node -> async.execute(node, report.getReport()));
