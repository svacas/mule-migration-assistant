...
public class IpFilterPolicyMigrationTestCase {
  ...
  public static Collection<Object[]> params() {
    return asList(new Object[][] {
        {"ip-filter-mule3-policy.xml", "ip-filter-mule4-policy.xml"},
    });
  }

  public IpFilterPolicyMigrationTestCase(final String original, final String target) {
  ...
  public void setUp() throws Exception {
    ...
    steps = ipFilterMigrationTask.getSteps().stream()
