...
public class ClientIdEnforcementPolicyMigrationTestCase {
  ...
  public ClientIdEnforcementPolicyMigrationTestCase(final String original, final String target) {
  ...
  public void setUp() throws Exception {
    ...
    steps = clientIdEnforcementMigrationTask.getSteps().stream()
